---
description: Batched discovery — groups up to 5 questions per round for token efficiency
...
### 1. Initial Discovery
Ask up to 5 questions at once using AskUserQuestion with multiple questions:
